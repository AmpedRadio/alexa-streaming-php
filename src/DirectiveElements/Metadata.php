 ...
 *   - Echo Spot: Scaled to 480 x 480, cropped to a circle, and displayed as the background image
 *                with 70% opacity black scrim.
 *
 * Background image
 *   - Recommended Minimum Size: 1024 x 640 pixels
 *   - Echo Show/Fire TV Cube: Scaled to 1024 x 640 and displayed as a background image. Your image
 *                             is displayed as is on the Echo Show or Fire TV Cube, so apply any
 *                             fading effects in your source image if needed. For instance, you
 *                             could apply a 70% opacity black layer over your image to give it a
 *                             faded appearance and make the text stand out.
 *   - Echo Spot: Not used.
 */
class Metadata
{
